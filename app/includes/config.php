...
define('RECAPTCHA_SITE_KEY', '-'); // Sostituisci con la tua Site Key
define('RECAPTCHA_SECRET_KEY', '-'); // Sostituisci con la tua Secret Key
...
define('SMTP_USER', ''); // Username SMTP (la tua email)
define('SMTP_PASS', '');          // Password SMTP (la tua password o App Password)
...
define('MAIL_FROM', ''); // Indirizzo email mittente
